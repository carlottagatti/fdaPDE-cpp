...
template <typename Model, typename RegularizationType> void RegressionBase<Model, RegularizationType>::set_dirichlet_bc(SparseBlockMatrix<double, 2, 2>& A, DVector<double>& b) {
